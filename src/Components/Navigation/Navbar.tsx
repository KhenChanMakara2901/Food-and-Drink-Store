...
export default function Navbar() {
  ...
  return (
    <div className="max-w-[1640px] mx-auto flex justify-between items-center p-4 align-baseline">
      ...
      <button className=" border-x-white text-yellow-600 hidden md:flex  py-2 rounded-full font-abc items-center  hover:bg-white underline underline-offset-2 animate-slide-in">
      ...
      >
        ...
        <ul className="flex flex-col p-4 text-yellow-600">
          <li className="text-xl py-4 flex ">
            ...
            <Link className="hover:scale-95 hover:underline font-abc" href="/">
              Home
            </Link>
          </li>
          <li className="text-xl py-4 flex ">
