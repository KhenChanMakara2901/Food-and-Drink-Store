...
export default function page() {
  return (
    <div className="max-w-[1640px] px-4 py-1">
      <section className="bg-slate-200 rounded-3xl">
        <div className="container px-6 py-12 mx-auto">
          <div className="lg:flex lg:items-center lg:-mx-6 animate-slide-in">
            <div className="lg:w-1/2 lg:mx-6">
              ...
              <div className="mt-6 w-80 md:mt-8">
                <h3 className="text-gray-600 dark:text-yellow-500 font-Text ">
                  Follow us
                </h3>
              ...
              <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white rounded-lg shadow-2xl dark:bg-gray-900 lg:max-w-xl shadow-gray-300/50 dark:shadow-black/50">
                <form className="mt-6">
                  <div className="flex-1">
                    ...
                    >
                      <option selected>Choose a People</option>
